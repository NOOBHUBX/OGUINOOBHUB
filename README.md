...
ToggleButton.MouseButton1Click:Connect(function()
	game.CoreGui:FindFirstChild("NOOBHUB").Enabled = not game.CoreGui:FindFirstChild("NOOBHUB").Enabled
end)
...
coroutine.wrap(
    ...
    local CoreGui = {}
    local CheckCoreGui = {}
    local CoreGui = game:GetService("CoreGui"):FindFirstChild("NOOBHUB")
        if CoreGui then 
         CoreGui:Destroy() 
        elseif CoreGui then 
        local CheckCoreGui = not game.CoreGui:FindFirstChild("NOOBHUB").Enabled
